...
public class ConstTaskBadges {
    ...
    public static final byte FAN_CUNG = 12;
    public static final byte VIP2 = 13;
    public static final byte VIP3 = 14;
    public static final byte VIP4 = 15;
    public static final byte PHICH_THU = 16;
    public static final byte LINH_THU_TRUYEN_KY = 17;
}
