...
public class ConstNpc {
        ...
        public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
                        ...
                        + "5 sao đen: 15% Sức đánh chí mạng\b6 sao đen: KI+20%\b7 sao đen: 15% Né đòn";
        ...
        public static final String HUONG_DAN_TOP_NV = "Mỗi ngày vào lúc 20h\n hãy đến đây nhận quà top nhiệm vụ, ngươi có 1 tiếng để nhận quà, quà sẽ làm mới vào mỗi ngày\n"
                        + "Top1: 20k coint\n"
                        + "Top2: 10k coint\n"
                        + "Top3:  5k coint\n"
                        + "Top4-10:   2k coint\n";
        ...
        public static final String THONG_TIN_SIEU_HANG = "Giải đấu thể hiện đẳng cấp thực sự\bCác trận đấu diễn ra liên tục bất kể ngày đêm\bBạn hãy tham gia thi đấu để nâng hạng\bvà nhận giải thưởng khủng nhé\n"
                        + "Cơ cấu giải thưởng như sau\b(chốt và trao giải ngẫu nhiên từ 20h-23h mỗi ngày)\bTop 1 thưởng 30 ngọc xanh\bTop 2-10 thưởng 20 ngọc xanhg\bTop 11-100 thưởng 5 ngọc xanh\bTop 101-1000 thưởng 1 ngọc xanh\n"
        ...
        public static final byte NGOKHONG = 48;
        ...
        public static final byte NANG_DE = 80;
        public static final byte BARD_DOCK = 81;
        public static final byte KY_NGO = 82;
        public static final byte EGG_HAC_HOA = 83;
        public static final byte MORO = 84;
        public static final byte JOYBOY = 85;
        ...
        public static final byte GAI1CON = 111;
        public static final byte Trunk = 113;
        public static final byte Nangde = 112;
        public static final byte Billbn = 107;
        public static final byte NHA_BEP = 91;
        // ----------------------index menu------------------------------------------
        ...
        public static final int MENU_ADMIN_CMD = 534;
        ...
        public static final int MENU_TET_EVENT = 31720025;
        ...
        // Mercenary
        public static final int MENU_MERCENARY = 32000; // Menu chọn loại lính (đánh boss / thường)
        public static final int MENU_MERCENARY_SELECT_TIME = 32001; // Menu chọn thời gian thuê
        public static final int MENU_MERCENARY_DETAIL = 32002; // Menu xem chi tiết lính (không dùng nữa)
        ...
        public static final int SET_TD = 1197;
        public static final int SET_NM = 1198;
        public static final int SET_XD = 1199;
        public static final int SET_TLTD = 1200;
        public static final int SET_TLNM = 1201;
        public static final int SET_TLXD = 1202;
        public static final int SET_KHTD = 1203;
        public static final int SET_KHNM = 1204;
        public static final int SET_KHXD = 1205;
        ...
        public static final int MENU_MERCENARY_REPLACE = 505;
}
