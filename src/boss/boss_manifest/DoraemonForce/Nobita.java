...
public class Nobita extends Boss {
    ...
    public Nobita() throws Exception {
        super(BossID.NOBITA_DRM, false, true, BossesData.NOBITA_DRM);
    }
    ...
    public void reward(Player plKill) {
        ...
        Service.gI().dropItemMap(this.zone, new ItemMap(zone, 382, Util.nextInt(1, 3),
    ...
    public void doneChatE() {
        ...
        for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if (boss.id == BossID.XUKA_DRM && !boss.isDie()) {
                return;
            }
        }
