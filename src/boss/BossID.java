...
public class BossID {
    ...
    public static final int BROLYANRGY = -3;
    public static final int BROLYHACHOA = -209;
    ...
    public static final int THAYMA = -352;
    ...
    public static final int TESTER_001 = -614;
    public static final int POC_BUNNY = -615;

    // ========================DOREMON FORCE========================
    public static final int XEKO_DRM = -616;
    public static final int CHAIEN_DRM = -617;
    public static final int XUKA_DRM = -618;
    public static final int NOBITA_DRM = -619;
    public static final int DOREMON = -620;
}
