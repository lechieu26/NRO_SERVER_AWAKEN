...
public class TienCapVegeta {
    ...
    public static boolean isVegeta(Item item) {
        return item.template.id >= 1416 && item.template.id <= 1421;
    }
    ...
    public static void showInfoCombine(Player player) {
        if (player.combine != null && player.combine.itemsCombine != null && player.combine.itemsCombine.size() == 3) {
            ...
            if (VegetaMask != null && upgradeItem != null && goldBar != null) {
                int upgradeCount = VegetaMask.template.id - 1416;
                ...
                Service.gI().sendThongBaoOK(player, "Cần 1 cải trang Vegeta, đủ số lượng Mảnh Cải trang và Thỏi vàng.");
            }
        } else {
            Service.gI().sendThongBaoOK(player, "Cần 1 cải trang Vegeta, đủ số lượng Mảnh Cải trang và Thỏi vàng.");
        }
    ...
    public static void startCombine(Player player) {
        if (player.combine.itemsCombine.size() == 3) {
            ...
            if (newId > 1421) {
                Service.gI().sendThongBaoOK(player, "Cải trang Vegeta đã đạt cấp tối đa!");
                return;
            }
