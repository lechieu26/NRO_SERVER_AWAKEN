...
public class TienCapTrunk {
    ...
    public static boolean isTrunk(Item item) {
        return item.template.id >= 1746 && item.template.id <= 1751;
    }
    ...
    public static void showInfoCombine(Player player) {
        if (player.combine != null && player.combine.itemsCombine != null && player.combine.itemsCombine.size() == 3) {
            ...
            if (trunkMask != null && upgradeItem != null && goldBar != null) {
                int upgradeCount = trunkMask.template.id - 1746;
                ...
                Service.gI().sendThongBaoOK(player, "Cần 1 cải trang Trunk, đủ số lượng Mảnh Cải trang và Thỏi vàng.");
            }
        } else {
            Service.gI().sendThongBaoOK(player, "Cần 1 cải trang Trunk, đủ số lượng Mảnh Cải trang và Thỏi vàng.");
        }
    ...
    public static void startCombine(Player player) {
        if (player.combine.itemsCombine.size() == 3) {
            ...
            if (newId > 1751) {
                Service.gI().sendThongBaoOK(player, "Cải trang Trunk đã đạt cấp tối đa!");
                return;
            }
